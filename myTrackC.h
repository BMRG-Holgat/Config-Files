...
IF(autoSelected_C)
    ...
    IFRANDOM(10) CALL(1321) FOLLOW(1331) ENDIF
    IFRANDOM(20) CALL(1322) FOLLOW(1331) ENDIF
    IFRANDOM(30) CALL(1323) FOLLOW(1331) ENDIF
    IFRANDOM(40) CALL(1324) FOLLOW(1331) ENDIF
    IFRANDOM(50) CALL(1325) FOLLOW(1331) ENDIF
    PRINT("C: NO TRAIN")
    FOLLOW(1331)
ELSE
    ROUTE_ACTIVE(1331)
