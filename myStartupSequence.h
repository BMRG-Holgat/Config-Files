...
ALIAS(autoSelected_E, 206) //Full auto Track E
ALIAS(autoRunning_E, 207) //Full auto Track E
ALIAS(autoSelected_F, 208) //Full auto Track F
ALIAS(autoRunning_F, 209) //Full auto Track F
