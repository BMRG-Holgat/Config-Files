...
ONOVERLOAD(C)
    SCREEN(4,0,"OVERLOAD")
    SCREEN(4,5, "OVERLOAD District B ")
...
ONOVERLOAD(D)
    ...
    SCREEN(3,0,"OVERLOAD")
    SCREEN(3,1, "OVERLOAD Accessory ")
    SCREEN(3,2," POWER OFF")
    SCREEN(4,0,"OVERLOAD")
    SCREEN(4,6, "OVERLOAD Accessory ")
    SCREEN(4,7," POWER OFF")
...
ROUTE(991,"Power Reset: Reset Scenic")
    SCREEN(2,3,"Reseting Power")
    SCREEN(4,3,"Reseting Power")
    SET_TRACK(B, MAIN)
    SET_POWER(B, ON)
    DELAY(5000)
    SCREEN(2,3,"")
...
ROUTE(990,"Power Reset: Reset District B")
    SCREEN(4,5,"Reseting District B")
    SET_TRACK(C, MAIN)
    SET_POWER(C, ON)
    DELAY(5000)
    SCREEN(4,5,"")
...
ROUTE(989,"Power Reset: Reset Accessory")
    SCREEN(2,7,"Reseting Power Acc")
    SCREEN(3,1,"Reseting Power Acc")
    SCREEN(4,7,"Reseting Power Acc")
    SET_TRACK(D, MAIN)
    SET_POWER(D, ON)
    DELAY(5000)
    SCREEN(2,7,"")
