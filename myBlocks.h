...
//Up Goods Slow
ALIAS(UGS_BK1_Stn_App,10) //Station approach B1
...
ALIAS(UGS_FY_Exit,9) // Exit from fiddle yards A & B to station B2
...
//Up Mixed Fast
ALIAS(UMF_FY_Ex,30) // Leave Fiddle Yard Board 4->3
